...
const CreatePage = () => {
 ...
 const form = useForm<z.infer<typeof formSchema>>({
   ...
   const onSubmit = async (values: z.infer<typeof formSchema>) => {
    ...
    return ( 
        <div className="max-x-5xl mx-auto flex md:items-center md:justify-center h-full p-6">
            <div>
                    ...
                    <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8 mt-8">
                        ...
                        render={({ field }) => (
                            <FormItem>
                                ...
                                <FormControl>
                                    <Input disabled= {isSubmitting} placeholder="e.g. ' Digital Logic Design '" {...field}/>
                                </FormControl>
                                <FormDescription>
